...
const ERROR_MESSAGES: Record<string, string> = {
  social_disabled: "Social login is currently disabled.",
  oauth_cancelled: "Sign-in was cancelled.",
  oauth_failed: "Social login failed. Please try again.",
  no_email: "Your social account has no email address. Please use email/password login.",
  server_error: "An unexpected error occurred. Please try again.",
  config: "Social login is not configured yet.",
};
