...
export default async function UserFavoritesPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    <div className="max-w-7xl mx-auto px-6 pt-10 pb-20 relative z-10">
      ...
      <div className="space-y-4 mb-10">
        ...
        <p className="text-muted-foreground font-bold italic max-w-2xl">
          A showcase of {user.name}&apos;s top-tier wrestling selections. Totaling {favMatches.length} gems.
        </p>
      </div>
