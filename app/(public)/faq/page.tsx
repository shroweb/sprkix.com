    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
      ...
      <div className="mt-20 bg-card/40 border border-primary/20 rounded-3xl p-8 sm:p-12 text-center space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
          <Link
            href="/register"
            className="h-12 px-8 bg-primary text-black text-sm font-black uppercase italic tracking-widest flex items-center justify-center gap-2 rounded-2xl shadow-xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all"
          >
            Create Free Account
          </Link>
          <Link
